...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'PROCESSING', 'PACKED', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'RETURN_REQUESTED', 'RETURNED');
...
-- CreateEnum
CREATE TYPE "StockMovementType" AS ENUM ('SALE', 'RETURN', 'RESTOCK', 'ADJUSTMENT', 'DAMAGE');

-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('REGISTERED', 'LOGIN', 'ORDER_CREATED', 'ORDER_CANCELLED', 'REVIEW_CREATED', 'PROFILE_UPDATED', 'ADDRESS_ADDED', 'WISHLIST_ADDED');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('NEW_ORDER', 'LOW_STOCK', 'OUT_OF_STOCK', 'NEW_REVIEW', 'RETURN_REQUEST', 'NEW_CUSTOMER');
...
CREATE TABLE "Setting" (
    ...
    "storeName" TEXT NOT NULL DEFAULT 'ElectroShop',
